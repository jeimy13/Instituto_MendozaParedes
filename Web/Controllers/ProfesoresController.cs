...
namespace Web.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public ProfesoresController(dbInstitutoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesores != null ? 
                          ...
                          Problem("Entity set 'dbInstitutoContext.Profesores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProfesor,NombreProfesor,EspecialidadProfesor")] Profesore profesore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProfesor,NombreProfesor,EspecialidadProfesor")] Profesore profesore)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'dbInstitutoContext.Profesores'  is null.");
            }
            var profesore = await _context.Profesores.FindAsync(id);
            if (profesore != null)
            {
